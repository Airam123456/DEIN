...
public class VisorAyudaController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		TreeItem<Help> r1Item = new TreeItem<Help>(new Help("Tema 1", "tema1.html"));
		...
		TreeItem<Help> r2Item = new TreeItem<Help>(new Help("Tema 2", "tema2.html"));
		...
		webEngine.load(getClass().getResource("/html/tema1.html").toExternalForm());
